    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        ...
        <p className="text-base text-gray-700 leading-relaxed">
          Le projet de synchronisation est une application web créée par l’équipe de développement du digital factory de Iwaco. Il a pour but de mettre à jour les produits publiés sur Shopify ainsi que l’alimentation d’une base de données par les commandes générées sur Shopify pour le traitement BI.
        </p>
        <p className="text-base text-gray-700 leading-relaxed">
        ...
        <ul className="list-disc pl-6 text-gray-700">
          ...
          <li>Dashboard pour la manipulation des synchronisations, le suivi des synchronisations, la gestion des backups, la gestion des comptes et la consultation des logs.</li>
        </ul>
      </div>

      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Architecture</h2>
        <p className="text-base text-gray-700 leading-relaxed">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Configuration du serveur</h2>
        <table className="w-full mb-8 bg-white shadow-md rounded-lg overflow-hidden">
          <tbody>
            ...
            <tr className="bg-gray-100 hover:bg-gray-200 transition-colors">
              <th className="text-left p-4 text-gray-800">Panneau de contrôle</th>
              <td className="p-4">WHM</td>
            </tr>
            <tr className="bg-white hover:bg-gray-100 transition-colors">
              <th className="text-left p-4 text-gray-800">Access panneau de contrôle</th>
              <td className="p-4">
                <a href="https://iwaco.ma:2087/" className="text-blue-500 hover:underline">
                  https://iwaco.ma:2087/
                </a>
              </td>
            </tr>
